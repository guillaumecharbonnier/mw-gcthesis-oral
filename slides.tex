...
\begin{frame}[plain]
  ...
  \includegraphics[width=1\textwidth, height=0.75\textheight, keepaspectratio]{\smi}%
  \note{Alors que dans le progéniteur lymphoïde, le verrou de la tri-méthylation est levé. Cet exemple très simplifié illustre pourquoi il est important de s'intéresser aux dynamiques épigénomiques dans différents modèles biologiques puisque différents mécanismes sont à l'oeuvre.}
\end{frame}
\begin{frame}[plain]
  \def\smi{out/ln/updir/mw-gcthesis-oral/ink/Cedar2011/fig5-custom-layout/1.pdf}
  \includegraphics[width=1\textwidth, height=0.75\textheight, keepaspectratio]{\smi}%
  \note{Les gènes bivalents possèdent à la fois la marque de répression H3K27me3 et celle d'activation H3K4me3. }
\end{frame}
\begin{frame}[plain]
  \def\smi{out/ln/updir/mw-gcthesis-oral/ink/Cedar2011/fig5-custom-layout/2.pdf}
  \includegraphics[width=1\textwidth, height=0.75\textheight, keepaspectratio]{\smi}%
  \note{Lire Tee2014 pour infos sur les symétries histoniques dans les nucléosomes.}
\end{frame}
\begin{frame}[plain]
...
\begin{frame}[plain]
  ...
  \includegraphics[width=1\textwidth, height=0.75\textheight, keepaspectratio]{\smi}
  \note{Présenter cas des promoteurs en introduction. Évoquer l'idée que des mécanismes différents sont à l’œuvre pour l'activation et l'inactivation de certains gènes. D'où l'intérêt d'étudier les mécanismes. Peut être retirer insulateur de la figure ?}
\end{frame}
\begin{frame}[plain]
