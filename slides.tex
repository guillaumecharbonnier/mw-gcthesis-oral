...
\note{Parler de H4K5ac/bu H4K8ac/bu ici et évoquer l'article. Conclure sur le travail titanesque de classifier fonctionnellement toutes les marques et variants: fonctions/interactions}
\end{frame}
\begin{frame}
  \vspace{.05\textheight}
